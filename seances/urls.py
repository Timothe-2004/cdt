...
from .views import SeanceViewSet, HistoriqueValidationViewSet, DashboardResponsableClasseViewSet, planifier_seance
from . import views
...
urlpatterns = [
    ...
    path('enseignant/seances/', views.enseignant_seances, name='enseignant_seances'),
    path('planifier/', planifier_seance, name='planifier_seance'),
    path('modifier/<int:seance_id>/', views.modifier_seance, name='modifier_seance')
]
