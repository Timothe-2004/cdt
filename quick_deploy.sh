...
echo "🚀 Déploiement rapide avec SQLite sur Render"
echo "============================================="
...
git commit -m "Deploy with SQLite to Render - $(date)"
...
echo "   - DEBUG: False"
echo "   - ALLOWED_HOSTS: votre-app.onrender.com"
echo "6. Déployez !"
echo ""
echo "🔑 Accès administrateur :"
echo "   - URL: https://votre-app.onrender.com/admin/"
